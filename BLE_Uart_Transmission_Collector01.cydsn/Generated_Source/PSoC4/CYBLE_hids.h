...
#define CYBLE_HIDSS_SERVICE_COUNT            (0x00u)
#define CYBLE_HIDSS_REPORT_COUNT             (0x00u)
...
/* Maximum supported count of HID services and reports */
#define CYBLE_HIDSC_SERVICE_COUNT            (0x01u)
#define CYBLE_HIDSC_REPORT_COUNT             (0x01u)
...
Parameters:
 serviceIndex: The sequence number of the HID Service
