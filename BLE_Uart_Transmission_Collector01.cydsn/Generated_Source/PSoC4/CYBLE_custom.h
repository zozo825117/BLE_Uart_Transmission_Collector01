...
#define CYBLE_CUSTOMC_CUSTOM_UART_TX_SERVICE_SERVICE_INDEX   (0x00u) /* Index of Custom Uart Tx Service service in the cyBle_customCServ array */
#define CYBLE_CUSTOMC_CUSTOM_UART_TX_SERVICE_CUSTOM_BUFFER_CHAR_INDEX   (0x00u) /* Index of Custom Buffer characteristic */
#define CYBLE_CUSTOMC_CUSTOM_UART_TX_SERVICE_CUSTOM_BUFFER_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
